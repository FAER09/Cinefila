...
import { createMovie, deleteMovie, logoutAdmin, updateMovie } from "@/app/actions";
...
export function AdminDashboard({ movies }: AdminDashboardProps) {
          ...
          {filteredMovies.map((movie) => (
            ...
            >
              <summary className="flex cursor-pointer list-none flex-wrap items-center justify-between gap-3 px-5 py-4">
                <div>
                  ...
                  <p className="text-sm text-[var(--muted)]">
                    {movie.rating.toFixed(1)} / 5 · {movie.reviews.length} reseñas
                  </p>
                </div>
              ...
              <div className="border-t border-[var(--border)] p-5">
                <form action={updateMovie} encType="multipart/form-data" className="space-y-4">
                ...
                <form action={deleteMovie} className="mt-4">
                  <input type="hidden" name="id" value={movie.id} />
                  <button
                    type="submit"
