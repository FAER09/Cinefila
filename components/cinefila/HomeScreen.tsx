...
export function HomeScreen({ movies, onCreateReview }: HomeScreenProps) {
    ...
    <>
      ...
      <section className="mx-auto flex w-full max-w-7xl flex-col gap-12 px-5 py-6 sm:px-8">
        <SectionHeading
          ...
          copy="Una experiencia sobria para descubrir peliculas, comentar y mantener el catalogo listo para desplegarse en Vercel."
        />
        <MovieShelf
